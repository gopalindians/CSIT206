<div class="ui small breadcrumb" style="margin: 20px 0px 10px 0px">
    ...
    <a class="section" href="/index.php?r=signup-lecturer.php">Lecturer</a>
    <i class="right chevron icon divider"></i>
...
<div class="ui vertical stripe quote segment" >
    <div class="ui two column middle aligned center aligned grid very relaxed stackable grid">
        <div class="column">
            <form class="ui form segment" action="/index.php?r=login-lecturer.php" method="post">
                <div class="ui form">
                    <div class="field">
        ...
        <div class="center aligned column">
            <a href="/index.php?r=signup-lecturer.php" class="ui big green labeled icon button">
